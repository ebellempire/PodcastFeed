...
<section aria-label="Settings Form">
	...
	<p><em><?php echo __('* All fields are required.');?></em></p>
	
	<fieldset id="podcast-feed-settings">
	
		<div class="field">
			<div class="two columns alpha">
				<label for="podcast_type">
					<?php echo __('Podcast Type'); ?>
				</label>
			</div>
			<div class="inputs five columns omega">
				...
				<p class="helper">
					<?php echo __('Specify episodic for stand-alone episodes or when you want your episodes presented and recommended newest-to-oldest, which is the default and most common type of podcast. Specify serial when you want your episodes presented and recommended oldest-to-newest.'); ?>
				</p>
			</div>
		</div>
		...
		<div class="field">
			<div class="two columns alpha">
				<label for="podcast_parental_advisory">
					<?php echo __('Parental Advisory'); ?>
				</label>
			</div>
			<div class="inputs five columns omega">
				<p class="explanation">
				...
				<?php echo get_view()->formCheckbox('podcast_parental_advisory', true, array('checked'=>(boolean)get_option('podcast_parental_advisory'))); ?>
	
				<p class="helper">
					<?php echo __('If you check this box, indicating the presence of explicit content, podcast directories may display an Explicit parental advisory graphic for your podcast. Podcasts containing explicit material aren’t available in some territories.'); ?>
				</p>
			</div>
		</div>
		...
		<div class="field">
			<div class="two columns alpha">
				<label for="podcast_category">
					<?php echo __('Podcast Category'); ?>
				</label>
			</div>
			<div class="inputs five columns omega">
				<p class="explanation">
		...
		<div class="field">
			<div class="two columns alpha">
				<label for="podcast_image_url">
					<?php echo __('Podcast Image URL'); ?>
				</label>
			</div>
	
			<div class="inputs five columns omega">
				<p class="explanation">
					<?php echo __("Enter the URL for your podcast image. "); ?>
				</p>
	
				<div class="input-block">
					<input type="text" class="textinput" name="podcast_image_url" value="<?php echo get_option('podcast_image_url'); ?>">
					<p class="helper">
						<?php echo __('<strong>Requirements</strong>: minimum size of 1400 x 1400 pixels; maximum size of 3000 x 3000 pixels; 72 dpi, in JPEG or PNG format with appropriate file extensions (.jpg, .png), and in the RGB colorspace.'); ?>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="field">
			<div class="two columns alpha">
				<label for="podcast_title">
					<?php echo __('Podcast Title'); ?>
				</label>
			</div>
	
			<div class="inputs five columns omega">
				<p class="explanation">
					<?php echo __("Enter the title for your podcast. "); ?>
				</p>
	
				<div class="input-block">
					<input type="text" class="textinput" name="podcast_title" value="<?php echo get_option('podcast_title'); ?>">
					<p class="helper">
						<?php echo __('Make your title specific and memorable.'); ?>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="field">
			<div class="two columns alpha">
				<label for="podcast_author">
					<?php echo __('Podcast Author'); ?>
				</label>
			</div>
	
			<div class="inputs five columns omega">
				<p class="explanation">
					<?php echo __("Enter the author for your podcast. "); ?>
				</p>
	
				<div class="input-block">
					<input type="text" class="textinput" name="podcast_author" value="<?php echo get_option('podcast_author'); ?>">
					<p class="helper">
						<?php echo __('Enter a name for the person or organization responsible for the podcast.'); ?>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="field fieldtrip child">
			<div class="two columns alpha">
				<label for="podcast_description">
					<?php echo __('Podcast Description'); ?>
				</label>
			</div>
	
			<div class="inputs five columns omega">
				<p class="explanation">
					<?php echo __("Enter text describing your podcast."); ?>
				</p>
				...
				<p class="helper">
					<?php echo __('Describe your podcast, including subject matter, episode schedule, and other relevant information. Apple Podcasts removes podcasts that include irrelevant words in this field so be sure to stay on topic.'); ?>
				</p>
			</div>
		</div>
		...
		<div class="field">
			<div class="two columns alpha">
				<label for="podcast_language">
					<?php echo __('Podcast Language'); ?>
				</label>
		    </div>
	
			<div class="inputs five columns omega">
				<p class="explanation">
					<?php echo __("Enter the language for your podcast. "); ?>
				</p>
	
				<div class="input-block">
					<input type="text" class="textinput" name="podcast_language" value="<?php echo get_option('podcast_language'); ?>">
					<p class="helper">
						<?php echo __('Enter a standard two-letter language identifier ( for example: en ), with or without a hyphenated two-letter subcode ( for example: en-us ). Please refer to the %s','<a target="_blank" href="https://cyber.harvard.edu/rss/languages.html">RSS 2.0 Specification</a>'); ?>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="field">
			<div class="two columns alpha">
				<label for="podcast_link">
					<?php echo __('Podcast Link URL'); ?>
				</label>
			</div>
	
			<div class="inputs five columns omega">
				<p class="explanation">
					<?php echo __("Enter the URL for your podcast information page. "); ?>
				</p>
	
				<div class="input-block">
					<input type="text" class="textinput" name="podcast_link" value="<?php echo get_option('podcast_link'); ?>">
					<p class="helper">
						<?php echo __('Enter the URL for a general information page where users can learn about your podcast, find episodes, etc. (for example, a collection page on this site containing your podcast items).'); ?>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="field">
			...
			<div class="inputs five columns omega">
				<p class="explanation">
					<?php echo __("Enter an email address for your podcast. "); ?>
				</p>
	
				<div class="input-block">
					<input type="text" class="textinput" name="podcast_email" value="<?php echo get_option('podcast_email'); ?>">
					<p class="helper">
						<?php echo __('Enter an email address to be used to verify your ownership of this podcast feed.'); ?>
					</p>
				</div>
			</div>
		</div>
...
<section aria-label="Usage Information">
